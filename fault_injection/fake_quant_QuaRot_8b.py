...
class NoisyW8A8LinearProtected(NoisyW8A8Linear):
    ...
    def forward(self, x):
        ...
        if "QuaRot" in self.method:
            ...
            weight_matrix, weight_scales = quantize_weight_per_channel_absmax(weight_matrix, n_bits=8)
        ...
        #_, p_out_scale = quantize_activation_per_token_absmax(y_for_quant, n_bits=8)
