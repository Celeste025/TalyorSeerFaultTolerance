...
def main(args):
    ...
    fiassistant.inject_fault_to_module(target=args.target, weight_quant='per_channel', act_quant='per_token', quantize_bmm_input=True, err_prob=0.0, target_layers=[])
    ...
    n = len(class_labels)
    # Sample 4 images for category label? n=1, 每个label一张图
...
if __name__ == "__main__":
    ...
    parser.add_argument("--target", type=str, default="DiT-XL256", help="target model to inject faults into")
