####差缺补漏：
# 1. 无保护1e-8 1e-9  ABFT_12   ABFT_12+step2t 1e-8 1e-9  √
# 2. cache inter 1 2 5 10 20  √
# 3. block_size 32 64 128 256
...
NUM_INFERENCE_STEPS_LIST=(50)
ERR_PROB_LIST=(1e-8 1e-9) 
TARGET_LIST=("DiTXL512full-step2t" "DiTXL512full")
TARGET_LAYERS_LIST=(
    ""  # 空表示所有层
)
